...
and the embedded :class:`~src.client.DeerFlowClient`.
...
Usage::
    ...
    from src.runtime.store.provider import get_store, store_context
...
from src.runtime.store._sqlite_utils import ensure_sqlite_parent_dir, resolve_sqlite_conn_str
...
def _sync_store_cm(config) -> Iterator[BaseStore]:
    ...
    :class:`~src.config.checkpointer_config.CheckpointerConfig` instance —
